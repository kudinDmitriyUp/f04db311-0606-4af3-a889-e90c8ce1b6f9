...
export const metadata: Metadata = {
  title: "Luxury Resort Thailand | Sanctuary - Beachfront Paradise",
  description: "Experience ultimate luxury at Sanctuary Resort, Thailand's premier beachfront destination. World-class spa, fine dining, and pristine beaches await your escape.",
  keywords: ["luxury resort Thailand", "beachfront hotel", "tropical paradise", "spa resort", "vacation packages", "Thailand getaway"],
  metadataBase: new URL("https://sanctuary-resort-thailand.com"),
  alternates: {
    canonical: "https://sanctuary-resort-thailand.com"
  },
  openGraph: {
    title: "Sanctuary Resort - Luxury Beachfront Thailand",
    description: "Escape to pure luxury. Discover our award-winning beachfront resort with world-class amenities and personalized service.",
    url: "https://sanctuary-resort-thailand.com",
    siteName: "Sanctuary Resort Thailand",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764015753283-1oxv73bu.jpg",
        alt: "Luxury beachfront resort Thailand"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Sanctuary Resort Thailand - Luxury Escape",
    description: "Experience paradise at our award-winning beachfront resort with premium rooms, spa, and dining.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764015753283-1oxv73bu.jpg"]
  },
  robots: {
    index: true,
    follow: true
